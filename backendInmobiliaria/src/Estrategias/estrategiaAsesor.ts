...
//los sgtes cambios:
/**
 * 1) Modificar el nombre de la Clase:EstrategiaAdmin->EstrategiaAsesor
 * 2) Modificar el nombre de la Estrategia: admin->asesor
 *   */ 
...
var respuesta:Boolean = false;
 ...
 export class EstrategiaAsesor implements AuthenticationStrategy{//Cambiamos nombre Clase
     //nombre de la estrategia
     name: string = "asesor"; //Cambiamos el nombre
        ...
        if (datos){
          ...
          if (datos.data.rol){
             ...
             if (respuesta){
                ...
                throw new HttpErrors[401]("Ud no tiene permisos de Asesor");
             } 
          }else{
            throw new HttpErrors[401]("Ud No tiene permisos de acceso para este recurso");
          }  
