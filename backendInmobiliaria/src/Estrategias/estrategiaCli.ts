...
//los sgtes cambios:
/**
 * 1) Modificar el nombre de la Clase:EstrategiaAdmin->EstrategiaCli
 * 2) Modificar el nombre de la Estrategia: admin->cli
 *   */ 
...
var respuesta:Boolean = false;
 ...
 export class EstrategiaCli implements AuthenticationStrategy{//Cambiamos nombre Clase
     //nombre de la estrategia
     name: string = "cli"; //Cambiamos el nombre
        ...
        if (datos){
          ...
          if (datos.data.rol){
             ...
             if (respuesta){
                ...
                throw new HttpErrors[401]("Ud no tiene permisos de Cliente");
             } 
          }else{
            throw new HttpErrors[401]("Ud No tiene permisos de acceso para este recurso");
          }  
